<?php
/*
   Weacoin block explorer. Forked from RPC Ace v0.8.0 (RPC AnyCoin Explorer)
*/
...
const BLOCKS_PER_LIST = 18;

const DB_FILE = false;

// for the example explorer
const COIN_HOME = 'https://explorer.pw';
...
echo '<tr><td>Forked from <a href="https://github.com/stolendata/rpc-ace/" target="_blank">RPC Ace</a> v' . ACE_VERSION . '</td><td>Network hashrate: </td><td>' . $ace['hashrate_mhps'] . ' MH/s</td></tr><tr><td> </td><td></td><td></td></tr></table>';
